...
The user interface and the server file interact with each other through `*Input()` and `*Output()` functions. The information in the server file is the recipe for how to construct objects in the ui. 
